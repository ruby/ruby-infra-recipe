...
```bash
# dry-run
for i in debian10 funtoo amazon amazon2 opensuseleap arch icc freebsd12 fedora31 centos6 centos7 debian8 debian9 debian openbsd ubuntu1604 ubuntu1804 ubuntu2004 riscv; do bundle exec hocho apply -n "${i}.rubyci.org"; done

# apply
for i in debian10 funtoo amazon amazon2 opensuseleap arch icc freebsd12 fedora31 centos6 centos7 debian8 debian9 debian openbsd ubuntu1604 ubuntu1804 ubuntu2004 riscv; do bundle exec hocho apply "${i}.rubyci.org"; done
```
